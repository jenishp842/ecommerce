...
const AddRolesPopup = (props) => {

  const { closePopup, role } = props;
            ...
            return (
              <>
                <div className="modal-body pt-0 plr-5 pb-5">
                  <h4 className="modal-title text-center f-24 mb-5 f-b" id="nRoleTitle">Create Role</h4>
                  ...
                  <div className="d-flex">
                    ...
                    <Button
                      ...
                      buttonText={successLoader ? <i class="fa fa-refresh fa-spin"></i> : 'Create Role'}
                      className="m-1"
                    />
