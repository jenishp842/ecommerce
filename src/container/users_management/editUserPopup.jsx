...
import { Modal, TextInput, Checkbox, Button, DropDown } from "../../component/index.jsx";
...
export default class EditUserPopup extends Component {
  ...
  clearForm = (resetForm) => {
    ...
    roleUser: '',
    mobile: this.props.editData.mobileNumber &&  this.props.editData.mobileNumber != null ? this.props.editData.mobileNumber : '',
  ...
  render() {
    const { closePopup, addPopupLoader, addPopup, editData } = this.props;
    const { error, errormessage } = this.state
    const { firstName, lastName, email, otherResponsibilities, userRole, mobileNumber, } = editData;
    const { _id } = userRole;
            ...
            return (
              <>
                <div className="modal-body pt-0 plr-5 pb-5">
                  <h4 className="modal-title text-center f-24 mb-5 f-b" id="nRoleTitle">Edit User</h4>
                  ...
                  {/* <div className="form-group row">
                    <label className="col-sm-4 col-form-label justify-content-start f-18 f-m">Password</label>
                    <div className="col-sm-8">
                      <TextInput
                        type="password"
                        name="password"
                  ...
                  <div className="form-group row align-items-center">
                    ...
                    <div className="col-sm-8">
                      <form className="d-flex flex-wrap">
                        ...
                        />
                        {/* <div className="formError"> {errors.templatesCheckbox != null ? errors.templatesCheckbox : null}</div> */}

                        {/* <div className="form-check-inline custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" id="customCheck25" name="example1" />
                          <label className="custom-control-label" htmlFor="customCheck25">Create</label>
                        </div> */}
                        {/* <div className="form-check-inline custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" id="customCheck215" name="example1" />
                          <label className="custom-control-label" htmlFor="customCheck215">Delete</label>
                        </div> */}
                        {/* <div className="form-check-inline custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" id="customCheck235" name="example1" />
                          <label className="custom-control-label" htmlFor="customCheck235">Edit</label>
                        </div> */}
                        {/* <div className="form-check-inline custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" id="customCheck2325" name="example1" />
                          <label className="custom-control-label" htmlFor="customCheck2325">View</label>
                        </div> */}
                      </form>
                    </div>
                  </div>
                  <div className="form-group row align-items-center">
                    ...
                    <div className="col-sm-8">
                      <form className="d-flex flex-wrap">
                        ...
                        {/* <div className="form-check-inline custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" id="customCheck214" name="example1" />
                          <label className="custom-control-label" htmlFor="customCheck214">View</label>
                        </div> */}
                      </form>
                    </div>
                  </div>
